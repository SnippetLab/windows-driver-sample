...
AccessFlagControlTest()
{
	...
	//this only when the include process names or process Ids list is not empty,
	//then after the include processes open the managed files, it then can't create the new files till the processes terminated. 
	//accessFlag = (~ALLOW_INCLUDE_PROCESS_SAVE_AS)&ALLOW_MAX_RIGHT_ACCESS;
