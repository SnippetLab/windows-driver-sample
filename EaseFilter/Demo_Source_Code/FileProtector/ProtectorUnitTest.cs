...
namespace FileProtector
{
    public partial class FileProtectorUnitTest : Form
    {
        ...
        private void AddProcessRightsUnitTest()
        {
            ...
            blockAccessFilterRule.ProcessRights = "cmd.exe:" + ((uint)FilterAPI.AccessFlag.LAST_ACCESS_FLAG).ToString();
        ...
        private void AddUserRightsUnitTest()
        {
            ...
            blockAccessFilterRule.UserRights = userName + ":" + ((uint)FilterAPI.AccessFlag.LAST_ACCESS_FLAG).ToString();
        ...
        private void NoRenameAndCopyUnitTest()
        {
            ...
            noRenameFilterRule.AccessFlag = (uint)((~FilterAPI.AccessFlag.ALLOW_FILE_RENAME) & (~FilterAPI.AccessFlag.ALLOW_FILE_DELETE)) & FilterAPI.ALLOW_MAX_RIGHT_ACCESS;


            //it can't create the new file with extension ".prt" anywhere except in the protected folder.
            FilterRule noCopyFilterRule = new FilterRule();
            noCopyFilterRule.IncludeFileFilterMask = "*.prt";
            noCopyFilterRule.ExcludeFileFilterMasks = unitTestFolder + "\\*";
            noCopyFilterRule.AccessFlag = (uint)(~FilterAPI.AccessFlag.ALLOW_OPEN_WITH_CREATE_OR_OVERWRITE_ACCESS) & FilterAPI.ALLOW_MAX_RIGHT_ACCESS;
            GlobalConfig.FilterRules.Add(noCopyFilterRule.IncludeFileFilterMask, noCopyFilterRule);
            ...
            try
            {
                ...
                try
                {
                    ...
                    AppendText("Test with block file rename failed.", Color.Red);
                    return;
                }
                catch
                {
                    AppendText("Test with block file rename passed.", Color.Green);
                ...
                try
                {
                    ...
                    AppendText("Test with block file delete failed.", Color.Red);
                    return;
                }
                catch
                {
                    AppendText("Test with block file delete passed.", Color.Green);
                ...
                try
                {
                    ...
                    AppendText("Test with block file creation failed.", Color.Red);
                    return;
                }
                catch
                {
                    AppendText("Test with block file creation passed.", Color.Green);
        ...
        private void FolderLockerUnitTest()
        {
            ...
            AuthorizedProcessFilterRule.AccessFlag = (uint)FilterAPI.AccessFlag.FILE_ENCRYPTION_RULE | FilterAPI.ALLOW_MAX_RIGHT_ACCESS;
            ...
            folderLockerFilterRule.AccessFlag = ((uint)FilterAPI.AccessFlag.FILE_ENCRYPTION_RULE | (uint)FilterAPI.AccessFlag.HIDE_FILES_IN_DIRECTORY_BROWSING)
